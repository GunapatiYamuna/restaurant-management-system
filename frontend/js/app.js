    ...
    function filterRestaurants(searchValue = null) {
        ...
        items.forEach(function (item) {
            ...
            const matchesCuisine =
                cuisine === "all" ||
                itemCuisine.split(",").map(value => value.trim().toLowerCase()).includes(cuisine.toLowerCase());
    ...
    if (reservationForm) {
        ...
        reservationForm.addEventListener(
            ...
            async function (event) {
                ...
                /* =========================================
                   SAVE BOOKING TO DJANGO + LOCAL STORAGE
                ========================================= */
                ...
                try {
                    ...
                    bookingData.reservationId = result.reservation_id;
                } catch (error) {
                    console.error("Reservation API error:", error);
                    const errorBox = document.getElementById("agreementError");
                    if (errorBox) errorBox.textContent = error.message || "Unable to connect to the server.";
                    return;
                }

                localStorage.setItem("foodieHubBooking", JSON.stringify(bookingData));
